...
def main(engine_path, video_path, image_size):
  ...
  with get_engine(engine_path) as engine, engine.create_execution_context() as context:
    ...
    image_src = cv2.imread(video_path)
    ...
    while(True):
      ...
      text = "fps={0:d}".format(fps)
      cv2.putText(img, text, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2, cv2.LINE_AA)
...
if __name__ == '__main__':
  ...
  main(engine_path, video_path, image_size)
